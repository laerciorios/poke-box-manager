...
The system SHALL render a `PokemonTooltip` wrapper that, on hover, displays a compact preview card containing the Pokemon's sprite, localized name, national Dex number, and type badge(s).
