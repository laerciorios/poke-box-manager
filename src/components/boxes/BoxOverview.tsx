...
function AddBoxGrid() {
  return (
    <div className="relative">
      <div className="grid grid-cols-6 gap-px rounded-md border border-dashed border-border bg-card p-1 transition-colors hover:border-accent/50">
